Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				...
				"name"			"DOCK11" [!$WINDOWS] // Primary font
				"tall"			"48" [$WINDOWS] // Size Huge Primary
				"tall"			"48" [!$WINDOWS] // Size Huge Primary
				"weight"		"0"
				"additive"		"0"
				"antialias"		"1"
		...
		"G_FontHuge_2"
		{
			"1"
			{
				"name"			"BebasNeue" [$WINDOWS] // Secondary font
				"name"			"BebasNeue" [!$WINDOWS] // Secondary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"DOCK11" [$WINDOWS] // Health Font | Primary font
				"name"			"DOCK11" [!$WINDOWS] // Health Font | Primary font
				"tall"			"42" // Size Huge Primary - Font Size Health
				"weight"		"0"
				"additive"		"0"
				"antialias"		"1"
			}
		...
		"G_FontAmmo"
		{
			"1"
			{
				...
				"name"			"DOCK11" [!$WINDOWS] // Ammo Font | Primary font
				"tall"			"42" // Size Huge Primary - Font Size Ammo
				"weight"		"0"
				"additive"		"0"
				"antialias"		"1"
			}
			...
			"G_FontReserve"
		{
			"1"
			{
				"name"			"DOCK11" [$WINDOWS] // Ammo Font | Primary font
				"name"			"DOCK11" [!$WINDOWS] // Ammo Font | Primary font
				"tall"			"21" // Size Huge Primary - Font Size Ammo
				"weight"		"0"
				"additive"		"0"
				"antialias"		"1"
			}
		...
		"G_FontMainMenu"
		{
			"1"
			{
				"name"			"BebasNeue" [$WINDOWS] // Primary font
				"name"			"BebasNeue" [!$WINDOWS] // Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"BebasNeue" [$WINDOWS] // Damage font | Primary font
				"name"			"BebasNeue" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"DOCK11" [$WINDOWS] // Target ID health font | Primary font
				"name"			"DOCK11" [!$WINDOWS] // Target ID health font | Primary font
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"Bebas Neue" [$WINDOWS] // Closed captions font | Secondary font
				"name"		"Bebas Neue" [!$WINDOWS] // Closed captions font | Secondary font
	...
	CustomFontFiles
	{
		...
		"18" "resource/fonts/Montserrat.ttf"
			 "name" "Monsterrat"
		"19" "resource/fonts/DOCK11.otf"
			"name"	"DOCK11"
		"20" "resource/fonts/BebasNeue.otf"
			"name" "BebasNeue"
